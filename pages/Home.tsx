  ...
  return (
    <section className="flex-col items-center justify-center h-screen relative pt-[2rem]">
      <div className="text-center">
        <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-slate-400 to-neutral-400 my-8 mt-36 text-lg sm:text-5xl lg:text-4xl lg:leading-normal font-extrabold">
          ...
          <div className="relative overflow-hidden h-12">
            <div className="relative flex flex-col animate-flip">
              <div className="flex justify-center items-center h-12 text-neutral-400 p-1">
                FullStack Developer
              </div>
              <div className="flex justify-center items-center h-12 text-neutral-400 p-1">
                Mobile Developer
